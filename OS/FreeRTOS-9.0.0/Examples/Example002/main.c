...
executing. */
const char *pcTextForTask1 = "Task one is running\r\n";
const char *pcTextForTask2 = "Task two is running\r\n";
...
int main( void )
{
	...
	xTaskCreate(	vTaskFunction,			/* Pointer to the function that implements the task. */
					"Task One",				/* Text name for the task.  This is to facilitate debugging only. */
	...
	xTaskCreate( vTaskFunction, "Task Two", 1000, (void*)pcTextForTask2, 1, NULL );
